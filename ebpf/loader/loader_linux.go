...
//
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -target native -cc clang -cflags "-O2 -g -Wall -Werror -Wno-missing-declarations" libssl ../programs/libssl.bpf.c -- -I../programs
